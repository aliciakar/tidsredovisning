...
function test_UppdateraAktivitet(): string {
    ...
    //Misslyckas med att uppdatera id=-1
        ...
        if($svar->getStatus()===400){
            ...
            $retur.="<p class='error'>Uppdatera aktivitet med id=-1 misslyckades, status" .$svar->getStatus() . "istället för förväntad 400</p>";
        }
    ...
    if($svar->getStatus()===400){
        ...
        $retur.="<p class='error'>Uppdatera aktivitet med id=0 misslyckades, status" .$svar->getStatus() . "istället för förväntad 400</p>";
    }
    ...
    $svar=uppdateraAktivitet("3.14", "Aktivitet");
        if($svar->getStatus()===400){
            ...
            $retur.="<p class='error'>Uppdatera aktivitet med id=3.14 misslyckades, status" .$svar->getStatus() . "istället för förväntad 400</p>";
        }
    //Misslyckas med att uppdatera aktivitet=''
    $svar=uppdateraAktivitet("345", "");
    if($svar->getStatus()===400){
        $retur .="<p class='ok'>Uppdatera aktivitet med tom aktivitet misslyckades, som förväntat</p>";
    } else{
        "<p class='error'>Uppdatera aktivitet med tom aktivitet misslyckades, status" . $svar->getStatus() . "returnerades istället för förväntat 400</p>";
    }
    ...
    $nyttId++;
    $svar=uppdateraAktivitet("$nyttId", "Whatever");
    if($svar->getStatus()===200 && $svar->getContent()->result===false){
...
function test_RaderaAktivitet(): string {
    ...
    try {
        ...
        if($svar->getStatus()===400){
            ...
            $retur .="<p class='error'>Radera aktivitet (-1) misslyckades.<br>"
        ...
        if($svar->getStatus()===400){
            ...
            $retur .="<p class='error'>Radera aktivitet (0) misslyckades.<br>"
            . $svar->getStatus() . " returnerades istället för förväntat 400.</p>";
        }
        ...
        if($svar->getStatus()===400){
            ...
            $retur .="<p class='error'>Radera aktivitet (3.14) misslyckades.<br>"
            . $svar->getStatus() . " returnerades istället för förväntat 400.</p>";
        }
